...
export declare function parseTweetsFromInstructions(instructions: any[] | undefined, quoteDepthOrOptions: number | ParseTweetsOptions): TweetData[];
export declare function extractCursorFromInstructions(instructions: Array<{
    entries?: Array<{
        content?: unknown;
    }>;
}> | undefined, cursorType?: string): string | undefined;
export declare function parseUsersFromInstructions(instructions: any[] | undefined): TwitterUser[];
export {};
