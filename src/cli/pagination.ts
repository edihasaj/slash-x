...
export function parsePositiveIntFlag(raw: string | undefined, flagName: string): {
    ok: true;
...
export function parseNonNegativeIntFlag(raw: string | undefined, flagName: string, defaultValue: number): {
    ok: true;
    value: number;
} | {
    ok: false;
...
export function parsePaginationFlags(cmdOpts: PaginationCmdOpts, opts?: {
