...
function readEnvCookie(cookies: TwitterCookies, keys: string[], field: 'authToken' | 'ct0'): void {
    if (cookies[field]) {
        return;
    }
...
export async function extractCookiesFromEdge(profile?: string): Promise<CookieExtractionResult> {
