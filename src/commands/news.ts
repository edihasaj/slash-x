...
import { type ExploreTab, type NewsItem, TwitterClient } from '../twitter/client.js';
...
function printNewsItems(items: NewsItem[], ctx: CliContext, opts: { json?: boolean; emptyMessage?: string; tweetLimit?: number } = {}): void {
    if (opts.json) {
