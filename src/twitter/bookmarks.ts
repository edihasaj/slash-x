...
export function withBookmarks<TBase extends AbstractConstructor<TwitterClientBase>>(Base: TBase): Mixin<TBase, TwitterClientBookmarkMethods> {
    ...
    return TwitterClientBookmarks as unknown as Mixin<TBase, TwitterClientBookmarkMethods>;
}
