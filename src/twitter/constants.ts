import queryIds from '../data/query-ids.json' with { type: 'json' };
...
export const TARGET_QUERY_ID_OPERATIONS: Array<OperationName> = Object.keys(FALLBACK_QUERY_IDS) as Array<OperationName>;
